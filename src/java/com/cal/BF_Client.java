 ...
 * @author Asus
 */
public class BF_Client extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            float waist,neck,hip,height;
            height=Float.parseFloat(request.getParameter("height"));
            waist=Float.parseFloat(request.getParameter("waist"));
            neck=Float.parseFloat(request.getParameter("neck"));
            hip=Float.parseFloat(request.getParameter("hip"));


            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Body Fat</title>");   
            out.println("<style>");
            out.println("body {");
            ...
            out.println("<calName><h1>Body Fat Calculator</h1></calName>");
            out.println("<form>");
            out.println("<center>");
            ...
            out.println("<tr>");
            out.println("   <td>");            
            out.println("       <h2>Waist (in cm): </h2>");
            out.println("   </td>");
            out.println("   <td>");            
            out.println("       <h2>"+waist+"</h2>");
            out.println("   </td>");
            out.println("</tr>");
            out.println("</tbody>");    
            out.println("<tbody>");            
            out.println("<tr>");
            out.println("   <td>");            
            out.println("       <h2>Neck (in cm): </h2>");
            out.println("   </td>");
            out.println("   <td>");            
            out.println("       <h2>"+neck+"</h2>");
            out.println("   </td>");
            out.println("</tr>");
            out.println("</tbody>"); 
            out.println("<tbody>");            
            out.println("<tr>");
            out.println("   <td>");            
            out.println("       <h2>Hip (in cm): </h2>");
            out.println("   </td>");
            out.println("   <td>");            
            out.println("       <h2>"+hip+"</h2>");
            out.println("   </td>");
            out.println("</tr>");
            out.println("</tbody>"); 
            out.println("</table>");          
            out.println("<res><h1>Result</h1></res>");
            out.println("<h2>Body Fat = " + getBFPCalc(height, waist, neck, hip, gender) + "%</h2> ");   
            out.println("</center>");            
            out.println("</form><br/>");
            out.println("<center>");
            ...
            Logger.getLogger(BF_Client.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private String getBFPCalc(float height, float waist, float neck, float hip, java.lang.String arg4) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        com.cal.WSProjectServer port = service.getWSProjectServerPort();
        return port.getBFPCalc(height, waist, neck, hip, arg4);
    }
