 ...
 * @author Asus
 */
public class BMI_Client extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<calName><h1>BMI Calculator</h1></calName>");
            out.println("<form>");
            out.println("<center>");
            ...
            String bmiResult = calcBmi(weight, height);
            out.println("<res><h1>Result</h1></res>");
            out.println("<h2>BMI = " +  bmiResult + " kg/m<sup>2</sup></h2>");  
            
            // Extract BMI value and category
            String[] bmiParts = bmiResult.split("\\s+"); // Split by whitespace
            float bmiValue = Float.parseFloat(bmiParts[0]);
            String bmiCategory;
            ...
            if (bmiValue < 18.5) {
                ...
                bmiCategory = "Normal";
                categoryColor = "#00FF00"; // Green
            } 
            else if (bmiValue >= 25 && bmiValue <= 29.9) {
                bmiCategory = "Overweight";
                categoryColor = "#FFA500"; // Orange
            } 
            else {
                bmiCategory = "Obesity";
                categoryColor = "#FF0000"; // Red (Obesity)
            }
            out.println("<h2>BMI Status = <span style=\"color: " + categoryColor + ";\">" + bmiCategory + "</span></h2>");
