 ...
 * @author Asus
 */
public class ABSI_Client extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            float waist,weight,height;
            weight=Float.parseFloat(request.getParameter("w"));
            waist=Float.parseFloat(request.getParameter("wc"));
            height=Float.parseFloat(request.getParameter("h"));
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>A Body Shape Index</title>");            
            out.println("<style>");
            out.println("body {");
            ...
            out.println("<calName><h1>A Body Shape Index Calculator</h1></calName>");
            out.println("<form>");
            out.println("<center>");
            ...
            out.println("<tr>");
            out.println("   <td>");            
            out.println("       <h2>Waist Circumference: </h2>");
            out.println("   </td>");
            out.println("   <td>");            
            ...
            out.println("<h2>ABSI = " + absi(weight,height,waist) + " m<sup>11/6</sup>/kg<sup>2/3</sup></h2>");   
            out.println("</center>");            
            out.println("</form></br>");
            out.println("<center>");
            ...
            Logger.getLogger(ABSI_Client.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
